        ...
        <section className='w-80 space-y-4 pb-6'>
          <div className='w-80 color-picker-ctn '>
            <input
              ...
              className={`border-2 w-full border-gray-700 px-5 py-3 rounded-lg  outline-none`}
              value={baseColor}
          ...
          <input
            className='border-2 border-gray-700 w-full py-3 bg-gray-900 text-white  px-4 rounded-lg'
            type='text'
            value={colorName}
